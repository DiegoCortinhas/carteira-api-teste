...
class TransacaoRepositoryTest {
	...
	void deveriaRetornarRelatorioDeCarteiraDeInvestimentos() {
		...
		.hasSize(7)
		.extracting(ItemCarteiraDto::getNome,ItemCarteiraDto::getQuantidade,ItemCarteiraDto::getPercentual)
		.containsExactlyInAnyOrder(
				Assertions.tuple("ITSA4",90l,0.125874),
				Assertions.tuple("BBSE3",80l,0.111888),
				Assertions.tuple("EGIE3",25l,0.034965),
				Assertions.tuple("SAPR4",120l,0.167832),
